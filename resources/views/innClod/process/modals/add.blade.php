<div class="modal fade" id="newProcess" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel4">Registrar Nuevo Proceso</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('process.store') }}" method="post">
                    ...
                    <div class="float-end">
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i>&nbsp;Crear proceso</button>
                    </div>
                </form>
